...
|---|---------|------|------------|--------|------|
| 1 | **Flappy Bird** | 2D Game | Intermediate | ✅ | [→](projects/Flappy-Bird) |
| 2 | **Tic Tac Toe** | Strategy Game | Beginner | ✅ | [→](projects/Tic-Tac-Toe) |
| 3 | **Snake** | Classic Game | Intermediate | ✅ | [→](projects/Snake) |
...
If your project fits a specific difficulty level, add it to the [Learning Path](#-learning-path) section:
...
**[⬆ Back to top](#-web-based-mini-projects)**
